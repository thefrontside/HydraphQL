...
with most basic Backstage types. We recommend to use it as a starting point for
further [extending] GraphQL schema. But if you'd like to implement your own type
structure you can use [Relation GraphQL module][relation-schema]. Relation module
contains only [`@relation`](./relation) schema directive and Catalog data loader.
Then you can setup [codegen] to generate GraphQL schema for clients and TypeScript
