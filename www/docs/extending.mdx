...
data source. To reveal a full power of HydraphQL you have to add at least one data source
also create your own custom loaders that you can use with
...
const loader = createLoader({ MyApi, Catalog });
